...
| instanceN | 3307+N | 6380+N | 3000+N | 5173+(N-1)*2 | 5174+(N-1)*2 |
...
./manage-instances.sh logs instance2 backend  # 只看后端日志
...
# 更新实例
./manage-instances.sh update instance2
./manage-instances.sh update-all  # 更新所有实例

# 备份数据
./manage-instances.sh backup instance2
./manage-instances.sh backup-all  # 备份所有实例
```
...
完整的多实例部署说明请参考：
- 📖 **[多实例快速开始.md](多实例快速开始.md)** - 一分钟快速上手
- 📖 **[多实例部署指南.md](多实例部署指南.md)** - 详细配置说明
